...
const Main = () => {
  ...
  return (
    <>
      <img className="header-rolls" src={dawn} alt="phantom" />
      <h1 className="brand-dawn" style={{ left: '36%' }}>
        DAWN
      </h1>

      <div className="text">
        So reinvent the wheel. Disrupt the norms.<br></br>
        Rip up the rule book. Dawn will be there for the ride.
      </div>
      <img className="ph1" src={ph1} alt="phantom" />
      <div className="slider">
        <div className="text">
          <h4>Maintain the correct image expected of your Dawn</h4>
          <br></br>
          In a world that tells you what to do, follow your instincts.
          Rolls‑Royce allows you to customise your<br></br> Dawn to suit your
        ...
        <img className="ph3" data-aos="zoom-in" src={da3} alt="ph3" />
      ...
      <div className="footer">
        ...
        <img className="phantom3" src={dawn3} alt="phhantom3" />
      </div>
    </>
  );
};
